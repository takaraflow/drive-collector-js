...
export async function stopProcessor() {
    logger.info("📴 正在停止 Processor 核心组件...");
    ...
    try {
        ...
        logger.info("✅ Processor 核心组件停止完成");
    } catch (e) {
        logger.error("❌ 停止 Processor 核心组件失败:", e);
        throw e;
    }
}