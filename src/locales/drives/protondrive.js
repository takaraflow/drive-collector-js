export const STRINGS = {
    ...
    input_2fa_optional: "🔢 <b>请输入当前 2FA 动态验证码</b>\n\n如果账号开启了 2FA，这里必须填写当前一次性验证码；未开启请留空发送。",
    input_otp_secret_key_optional: "🔐 <b>请输入 OTP Secret Key（可选）</b>\n\n对应 rclone 的 `otp_secret_key`。如果没有，请留空发送。",
