export const STRINGS = {
    ...
    files: {
        ...
        batch_empty: "ℹ️ 尚无文件排队或加载中。请向我发送多个文件或相册以创建批量任务。",
    ...
    task_queue: {
        ...
        no_active: "✅ 当前无活跃任务。请直接向我发送文件或链接来创建任务。",
        no_data: "📭 暂无任务记录。您可以向我发送文件、图片或链接来开始转存。",
        ...
        btn_back: "🔙 返回",
        btn_refresh: "🔄",
        no_tasks_in_status: "📭 该状态下暂无任务。您可以查看其他状态，或发送文件创建新任务。",
    },
