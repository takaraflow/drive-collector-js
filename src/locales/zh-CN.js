export const STRINGS = {
    ...
    status: {
        ...
        active_tasks: "⚡ 活跃任务",
        user_history: "👤 您的任务历史",
        no_tasks: "尚无任务记录。👉 提示：请直接向我发送文件、图片或链接，开始您的第一次转存吧！",
        no_active_tasks: "✅ 当前没有排队或处理中任务。👉 提示：您可以发送新的文件或链接来继续转存。",
    ...
    task_queue: {
        ...
        no_active: "✅ 当前无活跃任务。👉 提示：您可以发送文件或链接来创建新任务。",
        no_data: "📭 暂无任务记录。👉 提示：快发送文件或链接开始您的第一次转存吧！",
