...
class CacheService {
    ...
    async preheat(keys = []) {
        ...
        // ⚡ Bolt Optimization: Use continuous native async worker pool instead of chunked slice loops
        // This eliminates head-of-line blocking within batches and reduces memory overhead from closures
        let currentIndex = 0;
