...
class CacheService {
    ...
    async preheat(keys = []) {
        ...
        // ⚡ Bolt Optimization: Replace chunked array slice and Promise.allSettled with a continuous async worker pool.
        // This eliminates head-of-line blocking and reduces memory overhead from closures while maintaining a concurrency limit of 3.
        let currentIndex = 0;
