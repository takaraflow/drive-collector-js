...
class CacheService {
    ...
    async batchOperation(operations) {
        ...
        // ⚡ Bolt Optimization: Native async worker pool for batch processing
        // This provides concurrent I/O without upfront closure allocation or unbounded
        // connection exhaustion for large arrays, balancing throughput and memory.
