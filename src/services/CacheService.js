...
class CacheService {
    ...
    async batchOperation(operations) {
        ...
        // ⚡ Bolt Optimization: Use native async worker pool instead of array mapping
        // This prevents memory regressions and connection pool exhaustion from upfront
        // closure allocation when dealing with large operation arrays.
