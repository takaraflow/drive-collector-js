...
## 2026-06-19 - Add explicit CTAs to empty states
**Learning:** Conversational bots with empty states that lack clear next steps leave users confused about how to proceed.
**Action:** Always include clear, context-specific call-to-actions (CTAs) in empty state strings rather than generic statements.
