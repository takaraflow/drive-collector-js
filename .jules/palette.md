...
## 2026-07-07 - Actionable Empty States in Bot UI
**Learning:** Conversational bot interfaces lack standard UI cues, making dead ends confusing. Without a clear CTA, users may not know what to do next in an empty state.
**Action:** Always include clear, context-specific call-to-actions (CTAs) in empty state messages rather than generic statements, explicitly guiding the user on the next steps to take.
