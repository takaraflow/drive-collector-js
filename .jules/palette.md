...
## 2024-07-20 - Actionable Empty States in Conversational UIs
**Learning:** Text-based conversational UIs lack persistent visual affordances. When users encounter an empty state (e.g., no active tasks), a generic statement leaves them guessing what to do next.
**Action:** Always include clear, context-specific call-to-actions (CTAs) in conversational bot empty states to explicitly guide users on their next steps.
