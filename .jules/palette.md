...
## 2026-06-06 - Conversational Empty States
**Learning:** Conversational bot empty states must be contextual waypoints, not just informational placeholders.
**Action:** Always include a direct, actionable prompt (CTA) guiding the user to the next logical step.
